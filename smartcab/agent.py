    ...
    def choose_action(self, state):
        ...
        if self.learning == True:
            ...
            if(rand > (self.epsilon*100)):
                ...
                # get all keys with the highest value
                highestKeys = [key for key,value in self.Q[state].items() if value == highest]
                # set action to a random key from the set of all keys with the highest value
                action = random.choice(highestKeys)
        return action
